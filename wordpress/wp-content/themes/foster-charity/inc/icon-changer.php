...
class foster_charity_Icon_Changer extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <ul class="icon-list clearfix">
                    ...
                    <?php
                    $foster_charity_Icon_Changer_array = foster_charity_Icon_Changer_array();
                    foreach ($foster_charity_Icon_Changer_array as $foster_charity_Icon_Changer) {
                            $icon_class = $this->value() == $foster_charity_Icon_Changer ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($foster_charity_Icon_Changer).'"></i>
                            <span class="foster-charity-social-class">'.esc_attr($foster_charity_Icon_Changer).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function foster_charity_icon_customize_js() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/assets/css/fontawesome-all.css');
    wp_enqueue_script( 'foster-charity-customize-icon', esc_url(get_template_directory_uri()).'/assets/js/customize-icon.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'foster_charity_icon_customize_js' );

if(!function_exists('foster_charity_Icon_Changer_array')){
    function foster_charity_Icon_Changer_array(){
        return array("", 
        "fab fa-500px",
