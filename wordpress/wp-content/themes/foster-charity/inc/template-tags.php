 ...
 * Posts pagination.
 */
if ( ! function_exists( 'foster_charity_pagination_option' ) ) {
	function foster_charity_pagination_type() {
		$foster_charity_pagination_type = get_theme_mod( 'foster_charity_pagination_option', 'Default' );
		if ( $foster_charity_pagination_type == 'Default' ) {
