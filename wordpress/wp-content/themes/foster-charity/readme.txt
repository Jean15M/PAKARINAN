...
= 0.2 =
* Resolved theme audit errors.
* Done css customization.

= 0.3 =
* Added conditions in some files.
...
* Added button border option for blog page in customizer.
...
* Added enable / disable sidebar, fixed header, scroll to top, slider and slider button options for mobile media in customizer.
...
* Changed id name for responsive slider and scroll to top from color-option.php
* Resolved scroll to top error.
* Added show/hide search settings.
* Updated POT file.
...
* Added target="_blank" in free link.
...
= 0.9.9 =
* Added Single post date, author,comments option for single post settings.
* Updated POT file.  
...
* Added enable/disable nav links in single post settings.
...
= 1.1.8 =
* Added initial cap in post settings.
* Updated POT file.

== Resources ==

Foster Charity WordPress Theme, Copyright 2018 ThemesEye
Foster Charity is distributed under the terms of the GNU GPL
...
Foster Charity WordPress Theme is derived from Twenty Seventeen WordPress Theme, Copyright 2016 WordPress.org
Twenty Seventeen WordPress Theme is distributed under the terms of the GNU GPL

Foster Charity bundles the following third-party resources:
...
** Stocksnap Images
	...
	Slider Image, Copyright Aman Shrivastava
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/A7LS7BWQ1V

	Post Image, Copyright Abigail Keenan
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/KPCTZZ60NU

	Post Image, Copyright frank mckenna
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/VZ66NHFPRR

	Post Image, Copyright Colin Maynard
	License: CC0 1.0 Universal (CC0 1.0)
	Source: https://stocksnap.io/photo/AXIRTFTYRA