...
<article class="blog-sec animated fadeInDown p-2 mb-4">
    ...
    <div class="post-info py-1">
      ...
      <?php if( get_theme_mod( 'charity_fundraiser_metafields_time',true) != '') { ?>
        <span class="entry-comments ms-1 me-2"><i class="f<?php echo esc_attr(get_theme_mod('charity_fundraiser_posttime_icon',"fa fa-clock pe-2" )); ?>"></i> <?php echo esc_html( get_the_time() ); ?></span>
      <?php }?>
  	</div>
	<?php }?>
