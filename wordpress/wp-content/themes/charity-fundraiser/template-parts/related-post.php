			...
			<?php while ( $related_posts->have_posts() ) : $related_posts->the_post(); ?>
				...
				<div class="col-lg-4 col-md-4">
					<article class="blog-sec p-2 mb-4">
					    <div class="mainimage">
					      <?php 
					        if(has_post_thumbnail() && get_theme_mod('charity_fundraiser_featured_image',true) == true) {
					          the_post_thumbnail(); 
					        }
					      ?>    
					    </div>
					    ...
					    <?php if(get_the_excerpt()) { ?>
					        <div class="entry-content"><p><?php $charity_fundraiser_excerpt = get_the_excerpt(); echo esc_html( charity_fundraiser_string_limit_words( $charity_fundraiser_excerpt, esc_attr(get_theme_mod('charity_fundraiser_related_post_excerpt_number','20')))); ?> <?php echo esc_html( get_theme_mod('charity_fundraiser_button_excerpt_suffix','...') ); ?></p></div>
					    <?php }?>
