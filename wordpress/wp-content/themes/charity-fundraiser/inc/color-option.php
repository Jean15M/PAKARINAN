<?php
	...
	/*-------- Blog Post Alignment ------*/
	$charity_fundraiser_post_alignment = get_theme_mod('charity_fundraiser_blog_post_alignment', 'left');
	if($charity_fundraiser_post_alignment == 'center' ){
		$charity_fundraiser_custom_css .='.blog-sec, .blog-sec h2, .post-info, .blogbtn{';
			$charity_fundraiser_custom_css .='text-align: '. $charity_fundraiser_post_alignment .';';
		$charity_fundraiser_custom_css .='}';
	}elseif($charity_fundraiser_post_alignment == 'left' ){
		$charity_fundraiser_custom_css .='.blog-sec, .blog-sec h2, .post-info, .blogbtn{';
			$charity_fundraiser_custom_css .=' text-align: '. $charity_fundraiser_post_alignment .';';
		$charity_fundraiser_custom_css .='}';
	}elseif($charity_fundraiser_post_alignment == 'right' ){
		$charity_fundraiser_custom_css .='.blog-sec, .blog-sec h2, .post-info, .blogbtn{';
			$charity_fundraiser_custom_css .='text-align: '. $charity_fundraiser_post_alignment .';';
		$charity_fundraiser_custom_css .='}';
	}
	...
	$charity_fundraiser_blog_image_dimension = get_theme_mod('charity_fundraiser_blog_image_dimension', 'default');
	$charity_fundraiser_feature_image_custom_width = get_theme_mod('charity_fundraiser_feature_image_custom_width',250);
	$charity_fundraiser_feature_image_custom_height = get_theme_mod('charity_fundraiser_feature_image_custom_height',250);
	if($charity_fundraiser_blog_image_dimension == 'custom'){
		$charity_fundraiser_custom_css .='.blog-sec img{';
			$charity_fundraiser_custom_css .='width: '.esc_attr($charity_fundraiser_feature_image_custom_width).'px; height: '.esc_attr($charity_fundraiser_feature_image_custom_height).'px;';
		$charity_fundraiser_custom_css .='}';
	}
	...
	// responsive settings
	$charity_fundraiser_toggle_button_bg_color_settings = get_theme_mod('charity_fundraiser_toggle_button_bg_color_settings');
	$charity_fundraiser_custom_css .='.toggle-menu {';
	$charity_fundraiser_custom_css .='background-color: '.esc_attr($charity_fundraiser_toggle_button_bg_color_settings).';';
	$charity_fundraiser_custom_css .='} ';
	...
	$charity_fundraiser_resp_sidebar = get_theme_mod( 'charity_fundraiser_sidebar_hide_show',true);
    if($charity_fundraiser_resp_sidebar == true){
    	$charity_fundraiser_custom_css .='@media screen and (max-width:575px) {';
		$charity_fundraiser_custom_css .='#sidebar{';
			$charity_fundraiser_custom_css .='display:block;';
		$charity_fundraiser_custom_css .='} }';
	}else if($charity_fundraiser_resp_sidebar == false){
		$charity_fundraiser_custom_css .='@media screen and (max-width:575px) {';
		$charity_fundraiser_custom_css .='#sidebar{';
			$charity_fundraiser_custom_css .='display:none;';
		$charity_fundraiser_custom_css .='} }';
	...
	// site logo padding 
	$charity_fundraiser_logo_spacing = get_theme_mod('charity_fundraiser_logo_spacing', '');
	$charity_fundraiser_custom_css .='.logo{';
	$charity_fundraiser_custom_css .='padding: '.esc_attr($charity_fundraiser_logo_spacing).'px !important;';
	$charity_fundraiser_custom_css .='}';

	// site title color
	$charity_fundraiser_site_title_text_color = get_theme_mod('charity_fundraiser_site_title_text_color');
	$charity_fundraiser_custom_css .='.logo h1 a, .logo p.site-title a{';
		$charity_fundraiser_custom_css .='color: '.esc_attr($charity_fundraiser_site_title_text_color).' !important;';
	$charity_fundraiser_custom_css .='}';

	// site tagline color
	$charity_fundraiser_site_tagline_text_color = get_theme_mod('charity_fundraiser_site_tagline_text_color');
	$charity_fundraiser_custom_css .='.logo p.site-description{';
		$charity_fundraiser_custom_css .='color: '.esc_attr($charity_fundraiser_site_tagline_text_color).' !important;';
	$charity_fundraiser_custom_css .='}';

	// responsive slider
	if (get_theme_mod('charity_fundraiser_slider_responsive',true) == true && get_theme_mod('charity_fundraiser_slider_hide',false) == false) {
		$charity_fundraiser_custom_css .='@media screen and (min-width: 575px){
			#slider{';
			$charity_fundraiser_custom_css .=' display: none;';
		$charity_fundraiser_custom_css .='} }';
	}
	if (get_theme_mod('charity_fundraiser_slider_responsive',true) == false) {
		$charity_fundraiser_custom_css .='@media screen and (max-width: 575px){
			#slider{';
			$charity_fundraiser_custom_css .=' display: none;';
		$charity_fundraiser_custom_css .='} }';
	...
	// slider button
	if (get_theme_mod('charity_fundraiser_slider_button_responsive',true) == true && get_theme_mod('charity_fundraiser_slider_button',true) == false) {
		$charity_fundraiser_custom_css .='@media screen and (min-width: 575px){
			.more-btn{';
			$charity_fundraiser_custom_css .=' display: none;';
		$charity_fundraiser_custom_css .='} }';
	}
	if (get_theme_mod('charity_fundraiser_slider_button_responsive',true) == false) {
		$charity_fundraiser_custom_css .='@media screen and (max-width: 575px){
			.more-btn{';
			$charity_fundraiser_custom_css .=' display: none;';
		$charity_fundraiser_custom_css .='} }';
	...
	// menu padding
	$charity_fundraiser_menu_padding = get_theme_mod('charity_fundraiser_menu_padding',10);
	$charity_fundraiser_custom_css .='.nav-menu a, .sf-arrows ul .sf-with-ul, .sf-arrows .sf-with-ul, .nav ul li a{';
		$charity_fundraiser_custom_css .='padding: '.esc_attr($charity_fundraiser_menu_padding).'px;';
	$charity_fundraiser_custom_css .='}';

	// menu text transform
	$charity_fundraiser_theme_lay = get_theme_mod( 'charity_fundraiser_text_tranform_menu','Uppercase');
    if($charity_fundraiser_theme_lay == 'Uppercase'){
		$charity_fundraiser_custom_css .='.nav-menu ul li a{';
			$charity_fundraiser_custom_css .='';
		$charity_fundraiser_custom_css .='}';
	}else if($charity_fundraiser_theme_lay == 'Lowercase'){
		$charity_fundraiser_custom_css .='.nav-menu ul li a{';
			$charity_fundraiser_custom_css .='text-transform: lowercase;';
		$charity_fundraiser_custom_css .='}';
	}
	else if($charity_fundraiser_theme_lay == 'Capitalize'){
		$charity_fundraiser_custom_css .='.nav-menu ul li a{';
			$charity_fundraiser_custom_css .='text-transform: Capitalize;';
		$charity_fundraiser_custom_css .='}';
	}
	...
	// site logo margin 
	$charity_fundraiser_logo_margin_option = get_theme_mod('charity_fundraiser_logo_margin_option', '');
	$charity_fundraiser_custom_css .='.logo{';
	$charity_fundraiser_custom_css .='margin: '.esc_attr($charity_fundraiser_logo_margin_option).'px;';
	$charity_fundraiser_custom_css .='}';

	// menu color
	$charity_fundraiser_menu_color = get_theme_mod('charity_fundraiser_menu_color');

	$charity_fundraiser_custom_css .='.nav-menu a,.nav-menu .current_page_item > a, .nav-menu .current-menu-item > a, .nav-menu .current_page_ancestor > a{';
			$charity_fundraiser_custom_css .='color: '.esc_attr($charity_fundraiser_menu_color).' !important;';
	$charity_fundraiser_custom_css .='}';

	// menu hover color
	$charity_fundraiser_menu_hover_color = get_theme_mod('charity_fundraiser_menu_hover_color');
	$charity_fundraiser_custom_css .='.nav-menu a:hover, .nav-menu ul li a:hover, .nav-menu ul.sub-menu a:hover, .nav-menu ul.sub-menu li a:hover{';
			$charity_fundraiser_custom_css .='color: '.esc_attr($charity_fundraiser_menu_hover_color).' !important;';
	$charity_fundraiser_custom_css .='}';

	// Submenu color
	$charity_fundraiser_submenu_menu_color = get_theme_mod('charity_fundraiser_submenu_menu_color');
	$charity_fundraiser_custom_css .='.nav-menu ul.sub-menu a, .nav-menu ul.sub-menu li a{';
			$charity_fundraiser_custom_css .='color: '.esc_attr($charity_fundraiser_submenu_menu_color).' !important;';
	$charity_fundraiser_custom_css .='}';

	// Single post image border radious
	$charity_fundraiser_single_post_img_border_radius = get_theme_mod('charity_fundraiser_single_post_img_border_radius', 0);
	$charity_fundraiser_custom_css .='.feature-box img{';
		$charity_fundraiser_custom_css .='border-radius: '.esc_attr($charity_fundraiser_single_post_img_border_radius).'px;';
	$charity_fundraiser_custom_css .='}';

	// Single post image box shadow
	$charity_fundraiser_single_post_img_box_shadow = get_theme_mod('charity_fundraiser_single_post_img_box_shadow',0);
	$charity_fundraiser_custom_css .='.feature-box img{';
		$charity_fundraiser_custom_css .='box-shadow: '.esc_attr($charity_fundraiser_single_post_img_box_shadow).'px '.esc_attr($charity_fundraiser_single_post_img_box_shadow).'px '.esc_attr($charity_fundraiser_single_post_img_box_shadow).'px #ccc;';
	$charity_fundraiser_custom_css .='}';