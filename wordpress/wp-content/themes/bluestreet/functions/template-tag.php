...
if (!function_exists('bluestreet_header_center_layout')) :
    ...
    <!-- logo -->
        <div class="navbar-header index3">
                        ...
                        { 
                            ...
                            <a class="navbar-brand" href="<?php echo esc_url(home_url( '/' )); ?>">
                                ...
                                {   
                                    ...
                                    echo '<img src="'.esc_url($bluestreet_image[0]).'" alt="'.esc_attr(get_bloginfo( 'title' )).'" class="custom-logo"/>';
                                }?>
                            </a>
                        <?php
                        }
                        ...
                        {
                           if( ( (get_option('blogname')!='') || (get_option('blogdescription')!='' ) ) && ( ($bluestreet_current_options['display_site_title'] ==true) || ($bluestreet_current_options['display_site_tagline'] == true) )) 
                            { ?>
                                <div class="logo-link-url">
                                    <?php
                                if(get_option('blogname')!='' && $bluestreet_current_options['display_site_title'] ==true)
                                {?>
                                    ...
                                    if(get_option('blogdescription')!='' && $bluestreet_current_options['display_site_tagline'] ==true)
                                    {
