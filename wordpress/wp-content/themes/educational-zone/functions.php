...
function educational_zone_themepage(){
	$educational_zone_theme_info = add_theme_page( __('Theme Options','educational-zone'), __('Theme Options','educational-zone'), 'manage_options', 'educational-zone-info.php', 'educational_zone_info_page' );
}

function educational_zone_info_page() {
	$educational_zone_user = wp_get_current_user();
	$educational_zone_theme = wp_get_theme();
	?>
	<div class="wrap about-wrap educational-zone-add-css">
		<div>
			<h1>
				<?php esc_html_e('Welcome To ','educational-zone'); ?><?php echo esc_html( $educational_zone_theme ); ?>
			</h1>
