		...
		<div class="entry-content">
			...
			the_excerpt( sprintf(
				wp_kses(
					...
					__( 'Continue reading<span class="screen-reader-text"> "%s"</span>', 'writers-lifestyle' ),
					array(
						'span' => array(
							'class' => array(),
							),
			...
			wp_link_pages( array(
				'before' => '<div class="page-links">' . esc_html__( 'Pages:', 'writers-lifestyle' ),
				'after'  => '</div>',
				) );
				?>
				<div class="text-center">
					<a href="<?php the_permalink() ?>" class="blogpost-button"><?php echo __('<i class="fa fa-arrow-right"></i>', 'writers-lifestyle') ?></a>
				</div>
			</div><!-- .entry-content -->
